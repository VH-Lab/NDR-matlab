...
% ndr.test.reader.bjg.test - Test reading using Neuroscience Data Readers using BJG bin format
%
%  See also: ndr.reader.bjg
%
	plotit = 1;
	...
	r = ndr.reader('bjg'); % Open a BJG reader
	...
	if plotit
		...
		xlabel('Time (s)');
		ylabel('Data values');
		title(['BJG example data']);
    end
    
end % ndr.test.reader.bjg.test

...
% ndr.format.intan.read_Intan_RHD2000_HEADER - Read header information from a CED SOM or SMR file
%
...
%
% See also: ndr.format.ced.read_SOMSMR_DATAFILE, SONFILEHEADER (documents HEADER.fileinfo),

...
if (header.fileinfo.data_file_main_version_number == 1)
...
blockinfo    = struct('type','timestamp','block_offset',0,'bytes',num_samples_per_data_block*4,'bytes_per_sample',4,'samples_per_block',num_samples_per_data_block,'numchannels',1,...
        'interleaved',0,'precision',[int2str(num_samples_per_data_block) '*uint32=>uint32'],'scale',1.0/header.frequency_parameters.amplifier_sample_rate,'shift',0,...
...
if ((header.fileinfo.data_file_main_version_number == 1 && header.fileinfo.data_file_secondary_version_number >= 2) ...
        ...
        blockinfo(1).precision = [int2str(num_samples_per_data_block) '*int32=>int32'];
end;
blockinfo(2) = struct('type','amp','block_offset',0,'bytes',num_samples_per_data_block*2*num_amplifier_channels,...
		'bytes_per_sample',2,'samples_per_block',num_samples_per_data_block,'numchannels',num_amplifier_channels,...
	        'interleaved',1,'precision','*uint16=>uint16','scale',0.195,'shift',32768,...
		'sample_rate',header.frequency_parameters.amplifier_sample_rate);
blockinfo(3) = struct('type','aux','block_offset',0,'bytes',(num_samples_per_data_block/4)*2*num_aux_input_channels,...
		'bytes_per_sample',2,'samples_per_block',(num_samples_per_data_block/4),'numchannels',num_aux_input_channels,...
	        'interleaved',1,'precision','*uint16=>uint16','scale',37.4e-6,'shift',0,...
		'sample_rate',header.frequency_parameters.aux_input_sample_rate);
blockinfo(4) = struct('type','supply','block_offset',0,'bytes',1*2*num_supply_voltage_channels,...
		...
		'sample_rate',header.frequency_parameters.supply_voltage_sample_rate);
blockinfo(5) = struct('type','temp','block_offset',0,'bytes',1*2*(num_temp_sensor_channels>0),...
		...
		'sample_rate',header.frequency_parameters.supply_voltage_sample_rate);
blockinfo(6) = struct('type','board_adc','block_offset',0,'bytes',num_samples_per_data_block*2*num_board_adc_channels,...
		'bytes_per_sample',2,'samples_per_block',num_samples_per_data_block,'numchannels',num_board_adc_channels,...
...
blockinfo(7) = struct('type','din','block_offset',0,'bytes',num_samples_per_data_block*2*(num_board_dig_in_channels>0),...
		'bytes_per_sample',2,'samples_per_block',num_samples_per_data_block,'numchannels',uint16(num_board_dig_in_channels>0),...
	        'interleaved',0,'precision',[int2str(num_samples_per_data_block) '*uint16=>uint16'],'scale',1,'shift',0,...
		'sample_rate',header.frequency_parameters.amplifier_sample_rate);
blockinfo(8) = struct('type','dout','block_offset',0,'bytes',num_samples_per_data_block*2*(num_board_dig_out_channels>0),...
		'bytes_per_sample',2,'samples_per_block',num_samples_per_data_block,'numchannels',uint16(num_board_dig_out_channels>0),...
	        'interleaved',0,'precision',[int2str(num_samples_per_data_block) '*uint16=>uint16'],'scale',1,'shift',0,...
		'sample_rate',header.frequency_parameters.amplifier_sample_rate);
